...
class HunyuanVideoAttnProcessor2_0:
    ...
    def __call__(
        ...
        text_act_length = encoder_hidden_states.shape[1] - (attn_len - attention_mask.sum()) - 1
        text_act_end = text_act_length - encoder_hidden_states.shape[1]
...
class HunyuanVideoTransformer3DModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    def forward(
        ...
        if not return_dict:
            return (hidden_states, block_embed_list)
